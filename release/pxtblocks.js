...
var pxtblockly;
(function (pxtblockly) {
    class FieldImageLabel extends Blockly.FieldImage {
        constructor(value, options, opt_validator) {
            ...
            // 15 * value.length,
            // 20,
            (((_a = win.labelSize[value]) === null || _a === void 0 ? void 0 : _a.width) / ((_b = win.labelSize[value]) === null || _b === void 0 ? void 0 : _b.height)) * 34 || 15 * value.length, 34, 
            // 15 * value.length,
            // 20,
            `.`);
            this.isFieldCustom_ = true;
    ...
    pxtblockly.FieldImageLabel = FieldImageLabel;
})(pxtblockly || (pxtblockly = {}));
/// <reference path="../../localtypings/pxtblockly.d.ts" />
(function (pxtblockly) {
    class FieldImageIcon extends Blockly.FieldImage {
        constructor(value, options, opt_validator) {
            super(value, 20, 20, "asd");
            this.isFieldCustom_ = true;
        }
        getValue() {
            // getText() returns the value that is set by calls to setValue()
    ...
    pxtblockly.FieldImageIcon = FieldImageIcon;
})(pxtblockly || (pxtblockly = {}));
var pxtblockly;
(function (pxtblockly) {
